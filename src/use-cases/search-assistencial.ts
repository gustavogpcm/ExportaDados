...
//                             SITUACAO: registro?.situacao || null,
//                             CARATERINTERNACAO:
//                               registro?.caraterInternacao || null,
//                             NUMEROOPERADORA: registro?.numeroOperadora || null,
//                             NUMEROREGISTRO: registro?.numeroRegistro || null,
//                             NUMEROATENDIMENTO:
//                               registro?.numeroAtendimento || null,
//                             NUMEROAUTORIZACAO:
//                               registro?.numeroAutorizacao || null,
//                             DATAINTERNACAO: registro?.dataInternacao
//                               ? new Date(registro?.dataInternacao)
//                               : null,
//                             DATAAUTORIZACAO: registro?.dataAutorizacao
...
//                               registro?.usuarioCadastroAlta || null,
//                             CORRECAOREGISTRO:
//                               registro?.correcaoRegistro || null,
//                             USUARIOCORRECAO: registro?.usuarioCorrecao || null,
//                             DATAULTIMORECALCULO:
//                               registro?.dataUltimoRecalculo || null,
//                             INTERNADOOUTRASVEZES:
...
//                             PROCEDENCIA: registro?.procedencia || null,
//                             VENTILACAOMECANIA:
//                               registro?.ventilacaoMecanica || null,
//                             DATACADASTRO: registro?.dataCadastro
//                               ? new Date(registro?.dataCadastro)
//                               : null,
//                             USUARIOCADASTRO: registro?.usuarioCadastro || null,
...
//                               registro?.instituicao?.codigo || null,
//                             NOME_INSTITUICAO:
//                               registro?.instituicao?.nome || null,
//                             CODIGO_HOSPITAL: registro?.hospital?.codigo || null,
//                             NOME_HOSPITAL: registro?.hospital?.nome || null,
//                             CODIGOPACIENTE_BENEFICIARIO:
//                               registro?.beneficiario?.codigoPaciente || null,
...
//                               : null,
//                             SEXO_BENEFICIARIO:
//                               registro?.beneficiario?.sexo || null,
//                             IDADEEMANOS_BENEFICIARIO:
//                               registro?.beneficiario?.idadeEmAnos || null,
//                             IDADEEMMESES_BENEFICIARIO:
//                               registro?.beneficiario?.idadeEmMeses || null,
...
//                             CRM_MEDICO: crm_medico || null,
//                             ESPECIALIDADE_MEDICO: especialidade_medico || null,
//                             MEDICORESPONSAVEL_MEDICO:
//                               medico_responsavel || null,
//                             TIPOATUACAO_MEDICO: tipoatuacao_medico || null,
//                             DATAEXECUCAO_PROCEDIMENTO:
//                               data_execucao_procedimento
//                                 ? new Date(data_execucao_procedimento)
//                                 : null,
//                             NOME_MEDICO_PROCEDIMENTO:
//                               nome_medico_procedimento || null,
//                             UF_MEDICO_PROCEDIMENTO:
//                               uf_medico_procedimento || null,
//                             CRM_MEDICO_PROCEDIMENTO:
//                               crm_medico_procedimento || null,
//                             ESPECIALID_MEDICO_PROCED:
//                               especialid_medico_proced || null,
...
//                               : null,
//                             CONDICAOALTA_CTI:
//                               registro?.cti?.condicaoAlta || null,
//                             TIPO_CTI: registro?.cti?.tipo || null,
//                             PERMANENCIAPREVISTANAALTA_CTI:
//                               registro?.cti?.permanicenciaPrevistaNaAlta ||
//                               null,
//                             PERMANENCIAREAL_CTI:
//                               registro?.cti?.permantenciaReal || null,
//                             NOME_MEDICO_CTI:
//                               registro?.cti?.medico?.nome || null,
//                             UF_MEDICO_CTI: registro?.cti?.medico?.uf || null,
//                             CRM_MEDICO_CTI: registro?.cti?.medico?.crm || null,
//                             ESPECIALIDADE_MEDICO_CTI:
//                               registro?.cti?.medico?.especialidade || null,
...
//                               registro?.drgBrasilRefinado?.mdc?.codigo || null,
//                             DESCRICAO_MDC_CTI:
//                               registro?.drgBrasilRefinado?.mdc?.descricao ||
//                               null,
//                             LEITO_CTI: registro?.cti?.leito || null,
//                             PESONASCIMENTO_RN:
//                               registro?.rn?.pesoNacimento || null,
//                             IDADEGESTACIONAL_RN:
//                               registro?.rn?.idadeGestacional || null,
//                             COMPRIMENTO_RN: registro?.rn?.comprimento || null,
//                             SEXO_RN: registro?.rn?.sexo || null,
...
//                               registro?.altaAdminstratica?.numeroAutorizacao ||
//                               null,
//                             DATAAUTORIZACAO_ALTAADMIN: registro
//                               ?.altaAdminstratica?.dataAutorizacao
//                               ? new Date(
//                                   registro?.altaAdminstratica?.dataAutorizacao,
//                                 )
//                               : null,
...
//                               ?.altaAdminstratica?.dataAtendiminicial
//                               ? new Date(
//                                   registro?.altaAdminstratica
//                                     ?.dataAtendiminicial,
//                                 )
//                               : null,
//                             DATAATENDIMFINAL_ALTAADMIN: registro
//                               ?.altaAdminstratica?.dataAtendimentoFinal
//                               ? new Date(
//                                   registro?.altaAdminstratica
//                                     ?.dataAtendimentoFinal,
//                                 )
//                               : null,
//                             DATAANALISE_ANALICRIT:
//                               itemAnaliseCritica?.dataAnalise
...
//                               ?.dataInicial
//                               ? new Date(
//                                   registro?.suporteVentilatorio?.dataInicial,
//                                 )
//                               : null,
//                             DATAFINAL_SUPVENTIL: registro?.suporteVentilatorio
//                               ?.dataFinal
//                               ? new Date(
//                                   registro?.suporteVentilatorio?.dataFinal,
//                                 )
//                               : null,
//                             CODIGO_CIDPRINC:
//                               registro?.cidPrincipal?.codigo || null,
//                             DESCRICAO_CIDPRINC:
//                               registro?.cidPrincipal?.descricao || null,
//                             SENSIVELCUIDADPRIMA_CIDPRINC:
//                               registro?.cidPrincipal?.sensivelCuidadoPrimario ||
...
//                               null,
//                             GERENCIAVELEMERGENCIA:
//                               registro?.variaveis?.gerenciavelEmergencia ||
//                               null,
//                             IDOSOFRAGIL:
//                               registro?.variaveis?.idosoFragil || null,
//                             CODIGO_DRGBRASILREFIN:
//                               registro?.drgBrasilRefinado?.codigo || null,
//                             DESCRICAO_DRGBRASILREFIN:
//                               registro?.drgBrasilRefinado?.descricao || null,
...
//                               registro?.causaExterna?.descricao || null,
//                             TEMPO_CAUSAEXT:
//                               registro?.causaExterna?.tempo || null,
//                             DATAINICIAL_CAUSAEXT: registro?.causaExterna
//                               ?.dataInicial
//                               ? new Date(registro?.causaExterna?.dataInicial)
//                               : null,
//                             DATAFINAL_CAUSAEXT: registro?.causaExterna
//                               ?.dataFinal
//                               ? new Date(registro?.causaExterna?.dataFinal)
//                               : null,
//                           }
...
//                           )
//                         } else {
//                           for (const registroCti of registro.cti) {
//                             if (registro.rn <= 0) {
//                               const seq_paciente =
//                                 await this.recordAssistencialRepository.getSequence()
//                               const send = {
...
//                                   registro?.idInternacaoRecaida || null,
//                                 IDORIGEMRECAIDA:
//                                   registro?.idOrigemRecaida || null,
//                                 TOTALHORASVENTILACAOMECANICA:
//                                   registro?.totalHorasVentilacaoMecanica ||
//                                   null,
//                                 MODALIDADEINTERNACAO:
//                                   registro?.modalidadeInternacao || null,
//                                 DATACADASTROALTA: registro?.dataCadastroAlta
...
//                                   : null,
//                                 PERMANENPREVISTAINTER:
//                                   registro?.permanenciaPrevistaNaInternacao ||
//                                   null,
//                                 PERMANENCIAPREVISTANAALTA:
//                                   registro?.permanenciaPrevistaNaAlta || null,
//                                 PERMANENCIAREAL:
//                                   registro?.permanenciaReal || null,
//                                 PERCENTIL: registro?.percentil || null,
//                                 PROCEDENCIA: registro?.procedencia || null,
//                                 VENTILACAOMECANIA:
//                                   registro?.ventilacaoMecanica || null,
...
//                                   registro?.instituicao?.nome || null,
//                                 CODIGO_HOSPITAL:
//                                   registro?.hospital?.codigo || null,
//                                 NOME_HOSPITAL: registro?.hospital?.nome || null,
//                                 CODIGOPACIENTE_BENEFICIARIO:
//                                   registro?.beneficiario?.codigoPaciente ||
//                                   null,
//                                 PLANO_BENEFICIARIO:
//                                   registro?.beneficiario?.plano || null,
//                                 DATANASCIMENTO_BENEFICIARIO: registro
//                                   ?.beneficiario?.dataNascimento
//                                   ? new Date(
//                                       registro?.beneficiario?.dataNascimento,
//                                     )
//                                   : null,
//                                 SEXO_BENEFICIARIO:
//                                   registro?.beneficiario?.sexo || null,
...
//                                 TIPATUACAO_MEDICO_PROCED:
//                                   tipatuacao_medico_proced || null,
//                                 DATAINICIAL_CTI: registroCti.dataInicial
//                                   ? new Date(registroCti.dataInicial)
//                                   : null,
//                                 DATAFINAL_CTI: registroCti.dataFinal
//                                   ? new Date(registroCti.dataFinal)
//                                   : null,
//                                 CONDICAOALTA_CTI:
//                                   registroCti.condicaoAlta || null,
//                                 TIPO_CTI: registroCti.tipo || null,
//                                 PERMANENCIAPREVISTANAALTA_CTI:
//                                   registroCti.permanicenciaPrevistaNaAlta ||
//                                   null,
//                                 PERMANENCIAREAL_CTI:
//                                   registroCti.permantenciaReal || null,
//                                 NOME_MEDICO_CTI:
//                                   registroCti.medico?.nome || null,
//                                 UF_MEDICO_CTI: registroCti.medico?.uf || null,
//                                 CRM_MEDICO_CTI: registroCti.medico?.crm || null,
//                                 ESPECIALIDADE_MEDICO_CTI:
//                                   registroCti.medico?.especialidade || null,
//                                 CODIGO_HOSPITAL_CTI:
//                                   registroCti.hospital?.codigo || null,
//                                 NOME_HOSPITAL_CTI:
//                                   registroCti.hospital?.nome || null,
//                                 CODIGO_CIDPRINCIPAL_CTI:
//                                   registroCti.cidPrincipal || null,
//                                 DESCRICAO_CIDPRINCIPAL_CTI:
//                                   registroCti.descricaoCidPrincipal || null,
//                                 CODIGO_DRGBRASILREFINADO_CTI:
//                                   registro?.drgBrasilRefinado?.codigo || null,
//                                 DESCRI_DRGBRASILREFINADO_CTI:
//                                   registro?.drgBrasilRefinado?.descricao ||
//                                   null,
//                                 TIPO_DRGBRASILREFINADO_CTI:
//                                   registro?.drgBrasilRefinado?.tipo || null,
//                                 CODIGO_MDC_CTI:
//                                   registro?.drgBrasilRefinado?.mdc?.codigo ||
//                                   null,
//                                 DESCRICAO_MDC_CTI:
//                                   registro?.drgBrasilRefinado?.mdc?.descricao ||
//                                   null,
//                                 LEITO_CTI: registroCti.leito || null,
//                                 PESONASCIMENTO_RN:
//                                   registro?.rn?.pesoNacimento || null,
//                                 IDADEGESTACIONAL_RN:
//                                   registro?.rn?.idadeGestacional || null,
//                                 COMPRIMENTO_RN:
//                                   registro?.rn?.comprimento || null,
//                                 SEXO_RN: registro?.rn?.sexo || null,
//                                 NASCIDOVIVO_RN:
//                                   registro?.rn?.nascidoVivo || null,
//                                 TOCOTRAUMATISMO_RN:
//                                   registro?.rn?.tocoTraumatismo || null,
//                                 APGAR_RN: registro?.rn?.apgar || null,
//                                 APGARQUINTOMINUTO_RN:
...
//                                 LOCAL_SUPVENTIL:
//                                   registro?.suporteVentilatorio?.local || null,
//                                 DATAINICIAL_SUPVENTIL: registro
//                                   ?.suporteVentilatorio?.dataInicial
//                                   ? new Date(
//                                       registro?.suporteVentilatorio
//                                         ?.dataInicial,
//                                     )
//                                   : null,
//                                 DATAFINAL_SUPVENTIL: registro
//                                   ?.suporteVentilatorio?.dataFinal
//                                   ? new Date(
//                                       registro?.suporteVentilatorio?.dataFinal,
//                                     )
//                                   : null,
...
//                                   registro?.cidPrincipal?.descricao || null,
//                                 SENSIVELCUIDADPRIMA_CIDPRINC:
//                                   registro?.cidPrincipal
//                                     ?.sensivelCuidadoPrimario || null,
//                                 CODIGO_CIDSECUN: itemCidSec.codigo || null,
//                                 DESCRICAO_CIDSECUN:
//                                   itemCidSec.descricao || null,
//                                 SONDAVESICALDEDEMORA:
//                                   registro?.sondaVesicalDeDemora
//                                     ?.sondaVesicalDeDemora || null,
//                                 CATETERVASCULARCENTRAL:
...
//                                 GERENCIAVELATENCAOPRIMARIA:
//                                   registro?.variaveis
//                                     ?.gerenciavelAtencaoPrimaria || null,
//                                 GERENCIAVELEMERGENCIA:
//                                   registro?.variaveis?.gerenciavelEmergencia ||
//                                   null,
//                                 IDOSOFRAGIL:
...
//                                   ?.dataInicial
//                                   ? new Date(
//                                       registro?.causaExterna?.dataInicial,
//                                     )
//                                   : null,
//                                 DATAFINAL_CAUSAEXT: registro?.causaExterna
//                                   ?.dataFinal
...
//                               )
//                             } else {
//                               for (const registroRn of registro.rn) {
//                                 if (registro.sondaVesicalDeDemora <= 0) {
//                                   const seq_paciente =
//                                     await this.recordAssistencialRepository.getSequence()
//                                   const send = {
//                                     ID: seq_paciente[0].NEXTVAL,
...
//                                       registro?.internadooutrasvezes || null,
//                                     HOSPITALINTERNACAOANTERIOR:
//                                       registro?.hospitalinternacaoanterior ||
//                                       null,
//                                     REINTERNACAO:
//                                       registro?.reinternacao || null,
//                                     DATAPREVISTAALTA: registro?.dataPrevistaAlta
//                                       ? new Date(registro?.dataPrevistaAlta)
//                                       : null,
//                                     PERMANENPREVISTAINTER:
...
//                                       null,
//                                     PERMANENCIAPREVISTANAALTA:
//                                       registro?.permanenciaPrevistaNaAlta ||
//                                       null,
//                                     PERMANENCIAREAL:
//                                       registro?.permanenciaReal || null,
//                                     PERCENTIL: registro?.percentil || null,
...
//                                       registro?.beneficiario?.sexo || null,
//                                     IDADEEMANOS_BENEFICIARIO:
//                                       registro?.beneficiario?.idadeEmAnos ||
//                                       null,
//                                     IDADEEMMESES_BENEFICIARIO:
//                                       registro?.beneficiario?.idadeEmMeses ||
//                                       null,
//                                     IDADEEMDIAS_BENEFICIARIO:
//                                       registro?.beneficiario?.idadeEmDias ||
//                                       null,
//                                     NOME_MEDICO: nome_medico || null,
//                                     UF_MEDICO: uf_medico || null,
//                                     CRM_MEDICO: crm_medico || null,
...
//                                       registroCti.medico?.nome || null,
//                                     UF_MEDICO_CTI:
//                                       registroCti.medico?.uf || null,
//                                     CRM_MEDICO_CTI:
//                                       registroCti.medico?.crm || null,
//                                     ESPECIALIDADE_MEDICO_CTI:
//                                       registroCti.medico?.especialidade || null,
//                                     CODIGO_HOSPITAL_CTI:
//                                       registroCti.hospital?.codigo || null,
...
//                                       registroCti.descricaoCidPrincipal || null,
//                                     CODIGO_DRGBRASILREFINADO_CTI:
//                                       registro?.drgBrasilRefinado?.codigo ||
//                                       null,
//                                     DESCRI_DRGBRASILREFINADO_CTI:
//                                       registro?.drgBrasilRefinado?.descricao ||
//                                       null,
...
//                                       registro?.drgBrasilRefinado?.tipo || null,
//                                     CODIGO_MDC_CTI:
//                                       registro?.drgBrasilRefinado?.mdc
//                                         ?.codigo || null,
//                                     DESCRICAO_MDC_CTI:
//                                       registro?.drgBrasilRefinado?.mdc
//                                         ?.descricao || null,
//                                     LEITO_CTI: registroCti.leito || null,
//                                     PESONASCIMENTO_RN:
//                                       registroRn.pesoNacimento || null,
//                                     IDADEGESTACIONAL_RN:
//                                       registroRn.idadeGestacional || null,
//                                     COMPRIMENTO_RN:
//                                       registroRn.comprimento || null,
//                                     SEXO_RN: registroRn.sexo || null,
//                                     NASCIDOVIVO_RN:
//                                       registroRn.nascidoVivo || null,
//                                     TOCOTRAUMATISMO_RN:
//                                       registroRn.tocoTraumatismo || null,
//                                     APGAR_RN: registroRn.apgar || null,
//                                     APGARQUINTOMINUTO_RN:
//                                       registroRn.apgarQuintoMinuto || null,
//                                     ALTA48HORAS_RN:
//                                       registroRn.Alta48horas || null,
//                                     NUMEROAUTORIZACAO_ALTAADMIN:
//                                       registro?.altaAdminstratica
//                                         ?.numeroAutorizacao || null,
//                                     DATAAUTORIZACAO_ALTAADMIN: registro
...
//                                         ?.analiseCritica || null,
//                                     LOCAL_SUPVENTIL:
//                                       registro?.suporteVentilatorio?.local ||
//                                       null,
//                                     DATAINICIAL_SUPVENTIL: registro
//                                       ?.suporteVentilatorio?.dataInicial
//                                       ? new Date(
...
//                                     CAUSAEXTERNA: CAUSAEXTERNA_STR || null,
//                                     CAGRAVE:
//                                       registro?.variaveis?.caGrave || null,
//                                     GERENCIAVELATENCAOPRIMARIA:
//                                       registro?.variaveis
//                                         ?.gerenciavelAtencaoPrimaria || null,
//                                     GERENCIAVELEMERGENCIA:
//                                       registro?.variaveis
//                                         ?.gerenciavelEmergencia || null,
//                                     IDOSOFRAGIL:
//                                       registro?.variaveis?.idosoFragil || null,
//                                     CODIGO_DRGBRASILREFIN:
//                                       registro?.drgBrasilRefinado?.codigo ||
...
//                                       ?.dataFinal
//                                       ? new Date(
//                                           registro?.causaExterna?.dataFinal,
//                                         )
//                                       : null,
//                                   }
//                                   await writeLog(send)
...
//                                   )
//                                 } else {
//                                   for (const registroSondaVescialDeDemora of registro.sondaVesicalDeDemora) {
//                                     const seq_paciente =
//                                       await this.recordAssistencialRepository.getSequence()
//                                     const send = {
//                                       ID: seq_paciente[0].NEXTVAL,
...
//                                       RECAIDA: registro?.recaida || null,
//                                       ORIGEMREADMISSAO30DIAS:
//                                         registro?.origemReadmissao30Dias ||
//                                         null,
//                                       ORIGEMRECAIDA30DIAS:
//                                         registro?.origemRecaida30Dias || null,
//                                       IDINTERNACAORECAIDA:
...
//                                           : null,
//                                       USUARIOULTIMAALTERACAO:
//                                         registro?.usuarioUltimaAlteracao ||
//                                         null,
//                                       CODIGO_INSTITUICAO:
//                                         registro?.instituicao?.codigo || null,
//                                       NOME_INSTITUICAO:
...
//                                         registroCti.medico?.crm || null,
//                                       ESPECIALIDADE_MEDICO_CTI:
//                                         registroCti.medico?.especialidade ||
//                                         null,
//                                       CODIGO_HOSPITAL_CTI:
//                                         registroCti.hospital?.codigo || null,
//                                       NOME_HOSPITAL_CTI:
...
//                                         registroCti.cidPrincipal || null,
//                                       DESCRICAO_CIDPRINCIPAL_CTI:
//                                         registroCti.descricaoCidPrincipal ||
//                                         null,
//                                       CODIGO_DRGBRASILREFINADO_CTI:
//                                         registro?.drgBrasilRefinado?.codigo ||
//                                         null,
//                                       DESCRI_DRGBRASILREFINADO_CTI:
//                                         registro?.drgBrasilRefinado
//                                           ?.descricao || null,
//                                       TIPO_DRGBRASILREFINADO_CTI:
//                                         registro?.drgBrasilRefinado?.tipo ||
//                                         null,
//                                       CODIGO_MDC_CTI:
//                                         registro?.drgBrasilRefinado?.mdc
//                                           ?.codigo || null,
...
//                                           : null,
//                                       ANALISECRITICA_ANALICRIT:
//                                         itemAnaliseCritica.analiseCritica ||
//                                         null,
//                                       TIPO_SUPVENTIL:
//                                         registroSondaVescialDeDemora?.analiseCritica ||
//                                         null,
//                                       LOCAL_SUPVENTIL:
//                                         registro?.suporteVentilatorio?.local ||
//                                         null,
...
//                                         registro?.cidPrincipal?.codigo || null,
//                                       DESCRICAO_CIDPRINC:
//                                         registro?.cidPrincipal?.descricao ||
//                                         null,
//                                       SENSIVELCUIDADPRIMA_CIDPRINC:
//                                         registro?.cidPrincipal
//                                           ?.sensivelCuidadoPrimario || null,
//                                       CODIGO_CIDSECUN:
//                                         itemCidSec.codigo || null,
//                                       DESCRICAO_CIDSECUN:
//                                         itemCidSec.descricao || null,
//                                       SONDAVESICALDEDEMORA:
//                                         registroSondaVescialDeDemora?.sondaVesicalDeDemora ||
//                                         null,
//                                       CATETERVASCULARCENTRAL:
//                                         CATETERVASCULARCENTRAL_STR || null,
//                                       CLASSIFICACAOROBSON_PARTADEQ:
//                                         registro?.partoAdequado || null,
//                                       DRGADMISSIONAL:
//                                         registro?.drgAdmissional?.codigo ||
//                                         null,
//                                       CAUSAEXTERNA: CAUSAEXTERNA_STR || null,
//                                       CAGRAVE:
//                                         registro?.variaveis?.caGrave || null,
...
//                                           ?.gerenciavelEmergencia || null,
//                                       IDOSOFRAGIL:
//                                         registro?.variaveis?.idosoFragil ||
//                                         null,
//                                       CODIGO_DRGBRASILREFIN:
//                                         registro?.drgBrasilRefinado?.codigo ||
//                                         null,
...
//                                         null,
//                                       PESO_DRGBRASILREFIN:
//                                         registro?.drgBrasilRefinado?.peso ||
//                                         null,
//                                       CODIGO_MDC_DRGBRASILREFIN:
//                                         registro?.drgBrasilRefinado?.mdc
//                                           ?.codigo || null,
...
//                                       LEITO: registro?.leito || null,
//                                       DESCRICAO_CAUSAEXT:
//                                         registro?.causaExterna?.descricao ||
//                                         null,
//                                       TEMPO_CAUSAEXT:
//                                         registro?.causaExterna?.tempo || null,
//                                       DATAINICIAL_CAUSAEXT: registro
//                                         ?.causaExterna?.dataInicial
//                                         ? new Date(
//                                             registro?.causaExterna?.dataInicial,
//                                           )
//                                         : null,
...
//                                     // else {
//                                     //   for (const registroCateter of registro.cateterVascularCentral) {
//                                     //     const seq_paciente =
//                                     //       await this.recordAssistencialRepository.getSequence()
//                                     //     const send = {
//                                     //       ID: seq_paciente[0].NEXTVAL,
...
//                                     //         ?.causaExterna?.dataInicial
//                                     //         ? new Date(
//                                     //             registro?.causaExterna
//                                     //               ?.dataInicial,
//                                     //           )
//                                     //         : null,
//                                     //       DATAFINAL_CAUSAEXT: registro
//                                     //         ?.causaExterna?.dataFinal
//                                     //         ? new Date(
//                                     //             registro?.causaExterna?.dataFinal,
//                                     //           )
//                                     //         : null,
...
//                               TIPO_CTI: registroCti.tipo || null,
//                               PERMANENCIAPREVISTANAALTA_CTI:
//                                 registroCti.permanicenciaPrevistaNaAlta || null,
//                               PERMANENCIAREAL_CTI:
//                                 registroCti.permantenciaReal || null,
//                               NOME_MEDICO_CTI: registroCti.medico?.nome || null,
//                               UF_MEDICO_CTI: registroCti.medico?.uf || null,
//                               CRM_MEDICO_CTI: registroCti.medico?.crm || null,
//                               ESPECIALIDADE_MEDICO_CTI:
//                                 registroCti.medico?.especialidade || null,
